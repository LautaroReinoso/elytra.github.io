...
let track_list = [
  {
    name: "Silencio",
    path: "https://drive.google.com/drive/folders/16pQjF0jIZZ3aWjUxBrDtK6m_IY6tmieG.wav"
  },
  {
    name: "Vidala",
...
function loadTrack(track_index) {
    ...
    // establecer 1000 milisegundo del slider
    updateTimer = setInterval(seekUpdate, 1000);
    // pasar a siguiente track cuando finalize (evento "ended")
    curr_track.addEventListener("ended", nextTrack);
}
// resetear value de slider
